...
set(FLAGS                           "${CPU_FLAGS_STR} -fdata-sections -ffunction-sections -Wl,--gc-sections -Wno-comment")
set(CPP_FLAGS                       "${FLAGS} -fno-rtti -fno-exceptions -fno-threadsafe-statics")

string(APPEND CMAKE_C_FLAGS         " ${FLAGS}")
string(APPEND CMAKE_ASM_FLAGS       " ${FLAGS}")
string(APPEND CMAKE_CXX_FLAGS       " ${CPP_FLAGS}")
